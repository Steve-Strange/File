...
macro(Ubpa_AddDepPro projectName name version)
	...
	if("${_need_find}" STREQUAL TRUE)
		...
		if(${${name}_FOUND})
			...
			message(STATUS "searching _deps for ${name} ${version}")
			if(NOT EXISTS "${CMAKE_SOURCE_DIR}/_deps/${name}-${version}/CMakeLists.txt")
				message(FATAL_ERROR "${name} ${version} not found in ${CMAKE_SOURCE_DIR}/_deps")
			endif()
			FetchContent_Declare(
			  ${name}
			  SOURCE_DIR "${CMAKE_SOURCE_DIR}/_deps/${name}-${version}"
			)
...
if(NOT UCMake_FOUND)
	...
	if(NOT UCMake_FOUND)
		message(STATUS \"searching _deps for UCMake ${UCMake_VERSION}\")
			if(NOT EXISTS \"${PROJECT_SOURCE_DIR}/_deps/UCMake-${UCMake_VERSION}/CMakeLists.txt\")
				message(FATAL_ERROR \"UCMake ${UCMake_VERSION} not found in _deps\")
			endif()
			FetchContent_Declare(
			  UCMake
			  SOURCE_DIR \"${PROJECT_SOURCE_DIR}/_deps/UCMake-${UCMake_VERSION}\"
			)
